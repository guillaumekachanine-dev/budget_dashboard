...
const INSIGHT_DARK = {
  card: 'radial-gradient(120% 90% at 14% -8%, rgba(56, 189, 248, 0.28) 0%, rgba(56, 189, 248, 0) 58%), radial-gradient(98% 82% at 100% 100%, rgba(91, 87, 245, 0.24) 0%, rgba(91, 87, 245, 0) 62%), linear-gradient(145deg, #0B132B 0%, #151D35 47%, #2B3C56 100%)',
  cardBorder: 'rgba(56, 189, 248, 0.2)',
  cardBorderActive: 'rgba(56, 189, 248, 0.65)',
  text: '#FFFFFF',
  muted: 'rgba(255, 255, 255, 0.7)',
  dim: 'rgba(255, 255, 255, 0.45)',
  panel: 'linear-gradient(145deg, #070B14 0%, #0E1627 100%)',
  divider: 'rgba(255, 255, 255, 0.08)',
  chevronIdleBg: 'rgba(255, 255, 255, 0.1)',
  chevronOpenBg: 'rgba(255, 255, 255, 0.25)',
  chevronOpenIcon: '#FFFFFF',
}
  ...
  return (
    <motion.section
      ...
      style={{
        ...
        border: `1px solid ${INSIGHT_DARK.cardBorder}`,
