...
// Bitcoin/EUR — 5 ans (données estimées — désactivé, remplacé par BTC_PORTFOLIO_DATA)
const BTC_5Y_DATA: Array<{ date: string; value: number }> = [
...
// Synthèse globale PEG (dernière valeur connue)
const PEG_SYNTHESE = {
  valuationDate: '2026-05-16',
  totalValue: 7671.46,
  salariale: 6368.23,
  retraite: 1303.23,
  maxTotal: 9003.73,    // pic atteint mai 2024
  maxDate: '2024-05-16',
}
