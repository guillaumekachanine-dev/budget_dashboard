...
begin
  ...
  mapped_categories as (
    ...
    where c.flow_type in ('expense', 'savings')
  ),

  -- Lecture depuis la vue live (v_monthly_category_actuals_clean) au lieu de la
  -- table analytics_monthly_category_metrics qui nécessitait un refresh manuel.
  -- Les données reflètent maintenant l'état exact des transactions en temps réel.
  ...
  -- Détecte les mois disponibles depuis la vue live au lieu de analytics_monthly_metrics.
