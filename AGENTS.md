...
| Vercel | Déploiement |
| API Codex (Anthropic) | Feature NLP text-to-SQL |
...
1. **Home** — cartes comptes + carte hero KPIs compte courant
2. **Budgets** — solde header + barres progression catégories + analyse filtrée + NLP
3. **Charts** — visualisations interactives (dépenses, tendances, comparaisons)
4. **Épargne** — état épargne, objectifs, projections
5. **"+" central** — modale saisie rapide d'opération
